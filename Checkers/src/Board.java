...
//	private String WHITEDAMA = Character.toString((char)10686);
	...
	private boolean validateWhiteMovements(int index, int newIndex) 
	{
		...
		// A pe�a que atingir a oitava casa advers�ria, parando ali, ser�
		// promovida a "dama", pe�a de movimentos mais amplos que a simples
		// pe�a. Assinala-se a dama sobrepondo, � pedra promovida, outra da
		// mesma cor.
		else if (piece == WHITEDAMA && newPiece == BLANK) {
			// A dama pode mover-se para tr�s e para frente em diagonal uma casa
			// de cada vez, diferente das outras pe�as, que movimentam-se apenas
			// para frente em diagonal. A dama pode tamb�m tomar outra pe�a pela
			// frente ou por tr�s em diagonal.
	...
	{		
		...
		if (piece == BLACKPIECE && newPiece == BLANK) {
			// A pe�a movimenta-se em diagonal, sobre as casas escuras, para a
